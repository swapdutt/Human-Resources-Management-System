...
public class TaxService {
	...
	public Tax findTaxRecordByTaxId(Integer employeeId) throws TaxEntityAlreadyExistsException {
		...
		return taxRepository.findTaxRecordByEmployeeId(employeeId)
				.orElseThrow(() -> new TaxEntityWithEmployeeIdNotFoundException(
	...
	public Tax updateTaxInfoRecord(Integer employeeId, UpdateTaxRequest taxRequest)
			throws TaxEntityWithEmployeeIdNotFoundException {
	...
	public Double calculateTaxOfEmployee(Integer employeeId)
			throws TaxEntityWithEmployeeIdNotFoundException, ArithmeticException {
		...
		try {
			...
			System.out.println(
					"Final Tax Calculation is : " + finalTaxCalculation + " for the employee id : " + employeeId);
